...
-- 
-- New features like auditing views or adding replay functions were added by Oslandia's team (Hugo Mercier / Régis Haubourg)

-- Audit function are licensed using postgresql licence at start and are now packaged inside the QGIS history-viewer plugin for easier distribution, and facing a dead source repository
